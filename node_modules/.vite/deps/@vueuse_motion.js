...
import { isObject, useEventListener, noop, useIntersectionObserver, tryOnUnmounted as tryOnUnmounted$1, unrefElement, watchOnce, isNumber, useMediaQuery } from "@vueuse/core";
...
function useMotion(target, variants = {}, options) {
  ...
  watchOnce(() => unrefElement(target), (el) => {
    if (!el)
      return;
